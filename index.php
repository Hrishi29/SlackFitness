...
?>		  
          <li>
                    <a href="#page-content-wrapper"><span style="padding-right:5px">#</span><?php echo $r2['channels']; ?></a>
		  </li>			
...
?>		 
      ...
      <li>
                    ...
                    <a  href="#page-content-wrapper"><span style="padding-right:5px">#</span><?php echo $r24['channels']; ?></a>
		  </li>			
...
?>		 
      ...
      <li>
                    ...
                    <a href="#page-content-wrapper"><span style="padding-right:5px">#</span><?php echo $r25['channels']; ?></a>
		  </li>			
...
?>		 
      ...
      <li>
                    ...
                    <a class="actives" href="index.php"><span style="padding-right:5px">#</span><?php echo $r23['channels']; ?></a>
		  </li>			
