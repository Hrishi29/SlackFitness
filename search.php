...
<body>
	...
	?>
	<p style="font-family: 'Salsa'; font-weight:bold; font-size:2em" >Search For Messages</p>
	
	<form   method="post" action="search.php">
							<div class="input-group">
								
									<input type="text" class="form-control" name="mail_code" placeholder="Enter" required>
							</div>
							<br>
							
							<div class="input-group">
							<button  class="btn btn-md btn-success"  type="submit" name="submit_code">Search</button>
							</div>
